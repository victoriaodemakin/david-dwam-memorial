...
import Photo25 from "../../../public/assets/images/papa-memeber.jpg";
import Photo26 from "../../../public/assets/images/papa-mama-love.jpg";
import Photo27 from "../../../public/assets/images/papa-school-4.jpg";
import Photo28 from "../../../public/assets/images/papa-oldie.jpg";
import Photo29 from "../../../public/assets/images/papa-mama-5.jpg";
import Photo30 from "../../../public/assets/images/papa-navy-oldie.jpg";
import Photo31 from "../../../public/assets/images/papa-friend-6.jpg";
...
const galleryImages = [
  ...
  { id: 11, url: Photo11, alt: "David Dari Dwam daughter wedding moment" },
	  { id: 12, url: Photo12, alt: "David Dari Dwam school days", objectFit: "contain" },
  ...
  { id: 19, url: Photo19, alt: "David Dari Dwam and wife - lifelong partners", objectFit: "contain"  },
  {
    id: 20,
    url: Photo20,
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <header className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-black mb-2">
            Rev David Dari Dwam - A Life in Pictures
          </h1>
    ...
    <Section id="gallery" title="Gallery">
      <div className="text-center mb-12 animate-fade-in px-4">
        ...
        <h2 className="text-3xl lg:text-4xl font-bold text-black mb-2">
          Rev David Dari Dwam - A Glimpse Through the Years
        </h2>
        <p className="text-lg text-gray-600 mb-4">
