  ...
  const timelineData = [
    {
      ...
      description:
        "Born on September 25, to John Smith Dari and Tia Jones Dari (née Ademiluyi). \David was the cherished second child in a dynamic family of 6.",
      icon: "",
    },
    {
      year: "1957",
      ...
      description:
        "His foundational years were spent at St Stephen A, Ile Ife (1957–1963)",
      icon: "",
    },
    {
      year: "1963",
    ...
    },
    {
      ...
      title: "Nigeria Navy",
      description:
        "His passion led him to Obafemi Awolowo University (OAU), where he graduated in 1974 with a BSc in Microbiology",
      icon: "",
    },
		 {
      year: "1988",
      ...
      description:
        "Rev David Dari Dwam  was a magnetic force. His unique spirit touched the lives of all who knew him; his generosity knew no bounds. He truly connected with people.",
      icon: "",
    },
    {
      year: "1988",
